...
public class Jump : MonoBehaviour
{
	...
	void CheckTouch(Vector3 pos, string phase)
	{
		...
		{
			hero.GetComponent<Rigidbody2D>().AddForce(new Vector2(0f, jumpForce)); //Add jump force to hero
			GetComponent<AudioSource>().Play(); // play audio attached to this game object (jump sound)
		}
	}
}